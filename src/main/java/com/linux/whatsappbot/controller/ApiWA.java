...
public class ApiWA {
    ...
    public static void sendChatId(String chatId) throws IOException {
        URI uri = URI.create(API_URL + "sendMessage?token=" + TOKEN);
        Map<String, String> map = new HashMap<>();
        map.put("body", "Your ID: " + chatId);
        map.put("phone", chatId);
        ApiWA.postJSON(uri, map);
    }

    public static void sendFile(String chatId, String fileFormat) throws IOException {
        Map<String, String> formats = new HashMap<>();
        formats.put("doc", Base64Help.getDOC());
        formats.put("jpeg", Base64Help.getJPEG());
        formats.put("pdf", Base64Help.getPDFString());
        formats.put("mp3", Base64Help.getMP3String());

        Map<String, String> map = new HashMap<>();
        if (formats.containsKey(fileFormat)) {
            map.put("phone", chatId);
            map.put("body", formats.get(fileFormat));
    ...
    public static void sendOgg (String chatId) throws IOException {
        ...
        public static void sendGeo (String chatId) throws IOException {
        ...
        public static void sendDefault (String chatId) throws IOException {
            URI uri = URI.create(API_URL + "sendMessage?token=" + TOKEN);
            Map<String, String> map = new HashMap<>();
            map.put("phone", chatId);
        ...
        public void post (String uri, String data) throws IOException, InterruptedException {
